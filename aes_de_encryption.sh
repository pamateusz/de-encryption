...
#HERE BE CODE
/usr/bin/time -v openssl enc -aes-256-cbc -salt -k root -in meshserv.log.1 -out file1.enc
#end=$(date +%s)
...
/usr/bin/time -v  openssl enc -d -aes-256-cbc -k root -in file1.enc -out textdecryption.txt
